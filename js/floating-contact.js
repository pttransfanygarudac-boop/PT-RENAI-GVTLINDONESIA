...
(function () {
    ...
    function init() {
        ...
        wrap.innerHTML = `
            <button class="navbar-contact-toggle" type="button" aria-label="Buka kontak cepat" aria-expanded="false">
                <span>+</span>
            </button>
        ...
        const toggle = wrap.querySelector('.navbar-contact-toggle');
        const items = wrap.querySelector('.navbar-contact-items');
